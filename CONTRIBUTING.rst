...
Report Bugs
~~~~~~~~~~~
Report bugs at https://bitbucket.org/timcera/plottoolbox/issues?status=new&status=open
...
Submit Feedback
~~~~~~~~~~~~~~~
The best way to send feedback is to file an issue at https://bitbucket.org/timcera/plottoolbox
...
Get Started!
------------
Ready to contribute? Here's how to set up `plottoolbox` for local development.

1. Fork the `plottoolbox` repo on bitbucket at
   https://bitbucket.org/timcera/plottoolbox/fork.

2. Clone your fork locally::

    $ git clone git@bitbucket.org:your_bitbucket_login/plottoolbox.git

3. Install your local copy into a virtualenv. Assuming you have
   virtualenvwrapper installed, this is how you set up your fork for local
   development::

    $ mkvirtualenv plottoolbox
    $ cd plottoolbox
