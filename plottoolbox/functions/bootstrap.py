...
@mando.command("bootstrap", formatter_class=RSTHelpFormatter, doctype="numpy")
...
def bootstrap_cli(
    ...
    r"""Bootstrap plot randomly selects a subset of the imput time-series.
...
bootstrap.__doc__ = bootstrap_cli.__doc__
