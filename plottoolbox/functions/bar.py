...
plotutils.LINE_LIST = ["-", "--", "-.", ":", "solid", "dashed", "dashdot", "dotted"]

plotutils.HATCH_LIST = ["/", "\\", "|", "-", "+", "x", "o", "O", ".", "*"]


@mando.command("bar", formatter_class=RSTHelpFormatter, doctype="numpy")
...
def bar_cli(
    ...
    r"""Bar plot, sometimes called a "column" plot.
