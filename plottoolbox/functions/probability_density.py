...
@mando.command("probability_density", formatter_class=RSTHelpFormatter, doctype="numpy")
...
#     type=[str, ["domain", ["probability_density",],], 1,],
...
probability_density.__doc__ = probability_density_cli.__doc__
