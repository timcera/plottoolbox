...
@mando.command("weibull_xaxis", formatter_class=RSTHelpFormatter, doctype="numpy")
...
#     type=[str, ["domain", ["weibull_xaxis",],], 1,],
...
weibull_xaxis.__doc__ = weibull_xaxis_cli.__doc__
