...
@mando.command("lognorm_yaxis", formatter_class=RSTHelpFormatter, doctype="numpy")
    ...
    if logy is True:
        ...
        warnings.warn(
            tsutils.error_wrapper(
                """
The plot type {1} cannot also have the yaxis set to {0}.
...
lognorm_yaxis.__doc__ = lognorm_yaxis_cli.__doc__
