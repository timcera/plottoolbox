...
@mando.command("lognorm_xaxis", formatter_class=RSTHelpFormatter, doctype="numpy")
...
#     type=[str, ["domain", ["lognorm_xaxis",],], 1,],
...
lognorm_xaxis.__doc__ = lognorm_xaxis_cli.__doc__
